  ...
  return (
    <>
      <motion.nav
        ...
        className={cn('fixed top-0 left-0 right-0 z-50 transition-all duration-500', navBg)}
      >
            ...
            <div className="flex items-center gap-4">
              <a
                ...
                className={cn(
                  ...
                  scrolled || !isHome ? 'text-gold hover:text-gold-dark' : 'text-white/90 hover:text-white'
                )}
              >
                <Phone size={14} />
              ...
              <button
                ...
                className={cn('md:hidden p-2 transition-colors duration-300', textColor)}
        ...
        {menuOpen && (
          ...
          >
            <div className="flex-1 flex flex-col justify-center px-8 pt-24">
              ...
              >
                <a href={`tel:${settings.phone}`} className="flex items-center gap-3 text-gold text-lg">
                  <Phone size={16} />
                  {settings.phone}
                </a>
              </motion.div>
