                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <AnimatedSection direction="right">
                        ...
                        <div className="space-y-4 text-obsidian/60 text-lg leading-relaxed">
                            <p>
                                {SITE_NAME} was founded with a singular
                                mission: to create travel experiences so
                                perfectly tailored that they become defining
                                chapters in our clients&apos; lives.
                            </p>
                            <p>
                                Based in London, our team of specialist travel
                                designers have personally explored every
                                destination we offer. We don&apos;t sell
                                holidays from brochures — we share places we
                                genuinely love.
                            </p>
                            <p>
                                From the moment you first contact us to the day
                                you return home, you have a dedicated specialist
                                by your side — available 24 hours a day
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    <AnimatedSection className="text-center mb-16">
                        ...
                        <h2 className="font-serif text-4xl md:text-5xl text-obsidian">
                            What{" "}
                            <span className="italic text-gold">Drives</span> Us
                        </h2>
                    </AnimatedSection>
                ...
                <div className="max-w-3xl mx-auto px-6 text-center">
                    <AnimatedSection>
                        ...
                        <p className="text-obsidian/50 text-lg mb-10">
                            Speak to one of our specialists. There&apos;s no
                            obligation — just a conversation about where you
                            want to go.
                        </p>
